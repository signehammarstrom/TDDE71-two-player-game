...
{
public:
    Player(double xpos, double ypos, float scale = 150, std::string filename = "saucer_signe.png", std::string filename2 = "skier_bw.png", std::string filename3 = "skier_saturated.png"); //x och ypos behövs inte!!
    ~Player() = default;
