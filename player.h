...
{
public:
    Player(double xpos, double ypos, float scale = 150, std::string filename = "saucer_signe.png", std::string filename2 = "saucerbw_signe.png", std::string filename3 = "saucercolor_signe.png"); //x och ypos behövs inte!!
    ~Player() = default;
